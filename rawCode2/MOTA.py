...
gt_data = np.loadtxt("/Users/aayushjain/Downloads/sportsmot_publish/dataset/train/v_-6Os86HzwCs_c001/gt/gt.txt", delimiter=",")  # Replace with your GT file
track_data = np.loadtxt("/Users/aayushjain/Downloads/sportsmot_publish/tracker_output.txt", delimiter=",")  # Replace with ByteTrack results
